...
graph save "${path2}PhD Research/MURB Building IOT/Processed Data/figures/fmm_all_nonsmoke_smoke.gph", replace
graph save "${path2}PhD Research/MURB Building IOT/Processed Data/figures/fmm_all_nonsmoke_smoke.eps", replace
